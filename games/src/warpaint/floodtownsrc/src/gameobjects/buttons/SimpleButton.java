...
public class SimpleButton extends GameObject {
    ...
    private int visualHeight = 10;

    public SimpleButton(String defaultString, int xPos, int yPos, int fontSize, Runnable onClickAction) {
        this(defaultString, xPos, yPos, fontSize);
    ...
    public void render(@NotNull Graphics2D graphics2D) {
        ...
        graphics2D.fillRect(getXPos(), getYPos() + yHoverOffset, getWidth(), getHeight() + visualHeight);
        ...
        graphics2D.drawRect(getXPos(), getYPos() + getHeight() + yHoverOffset, getWidth(), visualHeight);
        graphics2D.setStroke(stroke);

        //shadow on bottom of the button
        graphics2D.setColor(lightShadow);
        graphics2D.fillRect(getXPos(), getYPos() + getHeight() + yHoverOffset, getWidth(), visualHeight);
    ...
    public SimpleButton setVisualHeight(int value) {
        this.visualHeight = value;
        return this;
    }

    public SimpleButton setFontColor(Color c) {
        this.fontColor = c;
        return this;
    }
